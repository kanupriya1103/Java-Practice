...
abstract class Sample2 {
	...
	private int d = 40; // within ParetClass only, not even in its sub-class
...
class Sample3 extends Sample2 implements A3, B3 {
	...
	public void display() {
		...
		System.out.println("b = " + b);
		System.out.println("c = " + c);
		// System.out.pritnln("d = " + d); // private menber can't accessed
	...
	public void run(int x) {
		System.out.println("This is a run overload method Sample3!");
	}
	public void run(int x, int y) {
		System.out.println("This is a overload method in Sample3!");
	}
